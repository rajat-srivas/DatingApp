...
namespace DatingApp.API.Data
{
    public class DatingRepository : IDatingRepository
    {
        ...
        public async Task<PagedList<User>> GetUsers(UserParams userParams)
        {
            ...
            users = users.Where(x=> x.Id != userParams.UserId).Where(x=>x.Gender == userParams.Gender);
        ...
        public async Task<Like> GetLike(int userId, int recepientId) => await _context.Likes.FirstOrDefaultAsync(x => x.LikerId == userId && x.LikeeId == recepientId);
    }
}